...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0, 0, 0, 0, 0 }  // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 5, 5, 2, 2, 2, 2, 2 } // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 4, 4, 4, 4 } // Re-Bump Speed Divisor (Divides the Homing Feedrate)
